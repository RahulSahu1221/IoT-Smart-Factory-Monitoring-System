...
#define TB_PORT         1883
#define ACCESS_TOKEN    "l7SSWdmQ0ghOkoqAMvzv"
#define CLIENT_ID       "ProductionLine0001"

//MQTT topic
#define TOPIC_TELEMETRY "v1/devices/me/telemetry"
#define TOPIC_RPC_REQUEST "v1/devices/me/rpc/request/+"    //subscribe to this topc
#define TOPIC_RPC_RESPONSE "v1/devices/me/rpc/response/"

 //time delay
#define TELEMETRY_INTERVAL    5000UL
#define RECONNECT_INTERVAL     5000UL
#define TEMP_CRIT 125.0f
